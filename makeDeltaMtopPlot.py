...
measurements = []
m_7TeV = measurement("7 TeV, lepton+jets (5 fb^{-1})")
...
m_8TeV = measurement("8 TeV, lepton+jets (19.7 fb^{-1})")
...
m_13TeV = measurement("13 TeV, single top (35.9 fb^{-1})")
m_13TeV.setResult(0.83, 1.79)
m_13TeV.setUncertainties(stat=0.69, exp=1.00, mod=1.29, theo=None)
...
pad2.cd()
dummy_uncerts = getDummyGraphUncert(0, 1.8, -1, 7, delta=True)
